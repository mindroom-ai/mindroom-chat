...
cache-order/hydration helper derivation, thread cache coverage helpers, and cache payload
serialization have been moved out of `RoomTimeline`. The next useful cleanup is extracting the
