...
| Normal room thread badge      | Not converted. `RoomTimeline` still computes summary/count/preview data near render.             | Add `ThreadBadgeViewModel` and replace the local render-path derivation.                      |
