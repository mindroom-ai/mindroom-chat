      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('sharedUi.powerChip.selfDemotion')}</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400, paddingTop: 0 }} direction="Column" gap="500">
              <Box direction="Column" gap="200">
                <Text priority="400">
                  {t('sharedUi.powerChip.youAreAboutToDemoteYourselfYouWillNotBeAbleTo')}
                </Text>
              </Box>
              <Box direction="Column" gap="200">
                <Button type="submit" variant="Warning" onClick={() => onChange(power)}>
                  <Text size="B400">{t('sharedUi.powerChip.demote')}</Text>
                </Button>
              </Box>
            </Box>
          </Dialog>
      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('sharedUi.powerChip.sharedPower')}</Text>
              </Box>
              <IconButton size="300" onClick={onCancel} radii="300">
                <Icon src={Icons.Cross} />
              </IconButton>
            ...
            <Box style={{ padding: config.space.S400, paddingTop: 0 }} direction="Column" gap="500">
              <Box direction="Column" gap="200">
                <Text priority="400">
                  {t('sharedUi.powerChip.youArePromotingTheUserToHaveTheSamePowerAsYourself')}
                </Text>
              </Box>
              <Box direction="Column" gap="200">
                <Button type="submit" variant="Warning" onClick={() => onChange(power)}>
                  <Text size="B400">{t('sharedUi.powerChip.promote')}</Text>
                </Button>
              </Box>
            </Box>
          </Dialog>
          ...
          >
            <Menu>
              ...
              >
                {error && (
                  <CutoutCard style={{ padding: config.space.S200 }} variant="Critical">
                    <Text size="L400">
                      {t('sharedUi.powerChip.errorName', { name: powerState.error.name })}
                    </Text>
              ...
              <div style={{ padding: config.space.S100 }}>
                ...
                >
                  <Text size="B300">{t('sharedUi.powerChip.managePowers')}</Text>
                </MenuItem>
              </div>
            </Menu>
          </FocusTrap>
