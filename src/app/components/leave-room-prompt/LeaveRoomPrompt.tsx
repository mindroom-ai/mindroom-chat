      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('sharedUi.leaveRoomPrompt.leaveRoom')}</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Box direction="Column" gap="200">
                <Text priority="400">
                  {t('sharedUi.leaveRoomPrompt.areYouSureYouWantToLeaveThisRoom')}
                </Text>
                {leaveState.status === AsyncStatus.Error && (
                  <Text style={{ color: color.Critical.Main }} size="T300">
                    {t('sharedUi.leaveRoomPrompt.leaveFailed', { error: leaveState.error.message })}
                  </Text>
                )}
              </Box>
              <Button
              ...
              >
                <Text size="B400">
                  {leaveState.status === AsyncStatus.Loading
                    ? t('sharedUi.leaveRoomPrompt.leaving')
                    : t('sharedUi.leaveRoomPrompt.leave')}
                </Text>
              </Button>
            </Box>
          </Dialog>
