...
export function SSOStage({
  ...
  return (
    <Dialog>
      ...
      >
        <Box grow="Yes">
          <Text size="H4">{t('sharedUi.sSOStage.ssoLogin')}</Text>
        </Box>
      ...
      >
        <Text size="T200">
          {t('sharedUi.sSOStage.toPerformThisActionYouNeedToAuthenticateYourselfBySsoLogin')}
        </Text>
        {errorCode && (
        ...
        {ssoWindow ? (
          <Button variant="Primary" onClick={handleSubmit}>
            <Text as="span" size="B400">
              {t('sharedUi.sSOStage.continue')}
            </Text>
          </Button>
        ) : (
          <Button variant="Primary" onClick={handleContinue}>
            <Text as="span" size="B400">
              {t('sharedUi.sSOStage.continueWithSso')}
            </Text>
          </Button>
        )}
      </Box>
