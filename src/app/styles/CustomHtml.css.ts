...
export const MindroomBlock = style([
  DefaultReset,
  MarginSpaced,
  {
    borderRadius: config.radii.R300,
...
export const MindroomBlockHeader = style([
  DefaultReset,
  {
    width: '100%',
    border: 'none',
...
export const MindroomBlockHeaderMeta = style({
  display: 'flex',
  alignItems: 'center',
  gap: config.space.S200,
});

export const MindroomBlockBody = style({
...
export const MindroomBlockResult = style([
  BaseCode,
  CodeFont,
  {
    marginTop: config.space.S200,
...
export const MindroomToolGroupList = style({
  display: 'flex',
