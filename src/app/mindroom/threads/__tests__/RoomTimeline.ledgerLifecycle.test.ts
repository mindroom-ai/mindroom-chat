...
// Ported from upstream #116 (momentum-loss fix): scroll elements with a
// recorded scrollTop write log plus manual scroll-event dispatch, and the
// settle-cause probe reader.
