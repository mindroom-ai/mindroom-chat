          ...
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">
                  {room.isSpaceRoom()
                    ? t('featureUi.commonSettings.general.roomUpgrade.spaceUpgrade')
                    : t('featureUi.commonSettings.general.roomUpgrade.roomUpgrade')}
                </Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Text priority="400" style={{ color: color.Critical.Main }}>
                <b>{t('featureUi.commonSettings.general.roomUpgrade.thisActionIsIrreversible')}</b>
              </Text>
              <Box direction="Column" gap="100">
                <Text size="L400">{t('featureUi.commonSettings.general.roomUpgrade.options')}</Text>
                <RoomVersionSelector
              ...
              >
                <Text size="B400">
                  {room.isSpaceRoom()
                    ? t('featureUi.commonSettings.general.roomUpgrade.upgradeSpace')
                    : t('featureUi.commonSettings.general.roomUpgrade.upgradeRoom')}
                </Text>
              </Button>
            </Box>
          </Dialog>
        ...
        description={
          replacementRoom
            ? tombstoneContent.body ||
              (room.isSpaceRoom()
                ? t('featureUi.commonSettings.general.roomUpgrade.spaceReplaced')
                : t('featureUi.commonSettings.general.roomUpgrade.roomReplaced'))
            : t('featureUi.commonSettings.general.roomUpgrade.currentVersion', {
                version: roomVersion,
              })
        }
        after={
          <Box alignItems="Center" gap="200">
            {predecessorRoomId && (
              ...
              >
                <Text size="B300">
                  {room.isSpaceRoom()
                    ? t('featureUi.commonSettings.general.roomUpgrade.oldSpace')
                    : t('featureUi.commonSettings.general.roomUpgrade.oldRoom')}
                </Text>
              </Button>
            )}
            {replacementRoom ? (
              ...
              >
                <Text size="B300">
                  {room.isSpaceRoom()
                    ? t('featureUi.commonSettings.general.roomUpgrade.openNewSpace')
                    : t('featureUi.commonSettings.general.roomUpgrade.openNewRoom')}
                </Text>
              </Button>
            ) : (
              <Button
              ...
              >
                <Text size="B300">{t('featureUi.commonSettings.general.roomUpgrade.upgrade')}</Text>
              </Button>
            )}
          </Box>
        }
