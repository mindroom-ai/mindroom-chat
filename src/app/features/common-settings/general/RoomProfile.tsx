    ...
    <Box as="form" onSubmit={handleSubmit} direction="Column" gap="400">
      <Box gap="400">
        <Box grow="Yes" direction="Column" gap="100">
          <Text size="L400">{t('featureUi.commonSettings.general.roomProfile.avatar')}</Text>
          {uploadAtom ? (
            ...
            <Box gap="200">
              ...
              >
                <Text size="B300">{t('featureUi.commonSettings.general.roomProfile.upload')}</Text>
              </Button>
              {!roomAvatar && avatar && (
                <Button
                  type="button"
                ...
                >
                  <Text size="B300">{t('featureUi.commonSettings.general.roomProfile.reset')}</Text>
                </Button>
              )}
              {roomAvatar && (
                <Button
                ...
                >
                  <Text size="B300">
                    {t('featureUi.commonSettings.general.roomProfile.remove')}
                  </Text>
                </Button>
              )}
            </Box>
      ...
      <Box direction="Inherit" gap="100">
        <Text size="L400">{t('featureUi.commonSettings.general.roomProfile.name')}</Text>
        <Input
          name="nameInput"
          defaultValue={name}
          variant="Secondary"
      ...
      <Box direction="Inherit" gap="100">
        <Text size="L400">{t('featureUi.commonSettings.general.roomProfile.topic')}</Text>
        <TextArea
          name="topicTextArea"
          defaultValue={topic}
          variant="Secondary"
      ...
      <Box gap="300">
        ...
        >
          <Text size="B300">{t('featureUi.commonSettings.general.roomProfile.save')}</Text>
        </Button>
        <Button
          type="reset"
          onClick={onClose}
          ...
          radii="300"
        >
          <Text size="B300">{t('featureUi.commonSettings.general.roomProfile.cancel')}</Text>
        </Button>
      </Box>
    </Box>
  );
...
export function RoomProfile({ permissions }: RoomProfileProps) {
  ...
  return (
    <Box direction="Column" gap="100">
      <Text size="L400">{t('featureUi.commonSettings.general.roomProfile.profile')}</Text>
      <SequenceCard
            ...
            <Box grow="Yes" direction="Column" gap="300">
              <Box direction="Column" gap="100">
                <Text className={BreakWord} size="H5">
                  {name ?? t('featureUi.commonSettings.general.roomProfile.unknown')}
                </Text>
                {topic && (
              ...
              {canEdit && (
                <Box gap="200">
                  ...
                  >
                    <Text size="B300">
                      {t('featureUi.commonSettings.general.roomProfile.edit')}
                    </Text>
                  </Chip>
                </Box>
              )}
