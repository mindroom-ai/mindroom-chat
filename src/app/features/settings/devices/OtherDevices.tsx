  ...
  return devices.length > 0 ? (
    <>
      <Box direction="Column" gap="100">
        <Text size="L400">{t('featureUi.settings.devices.otherDevices.others')}</Text>
        {authMetadata && (
          <SequenceCard
          ...
          >
            <SettingTile
              title={t('featureUi.settings.devices.otherDevices.deviceDashboard')}
              description={t(
                'featureUi.settings.devices.otherDevices.manageYourDevicesOnOidcDashboard'
              )}
              after={
                <Button
                  size="300"
                ...
                >
                  <Text size="B300">{t('featureUi.settings.devices.otherDevices.open')}</Text>
                </Button>
              }
            />
          </SequenceCard>
          ...
          <Box alignItems="Center" gap="400">
            <Box grow="Yes" direction="Column">
              {deleteError ? (
                <Text size="T200">
                  <b>
                    {t('featureUi.settings.devices.otherDevices.logoutFailed', {
                ...
                <Text size="T200">
                  <b>
                    {t('featureUi.settings.devices.otherDevices.logoutSelectedDevices', {
                      count: deleted.size,
                    })}
                  </b>
                </Text>
              ...
              {authData && (
                <ActionUIAFlowsLoader
                  ...
                  unsupported={() => (
                    <Text size="T200">
                      {t(
                        'featureUi.settings.devices.otherDevices.authenticationStepsToPerformThisActionAre'
                      )}
                    </Text>
                  )}
                >
            ...
            <Box shrink="No" gap="200">
              ...
              >
                <Text size="B300">{t('featureUi.settings.devices.otherDevices.cancel')}</Text>
              </Button>
              <Button
                size="300"
                variant="Critical"
              ...
              >
                <Text size="B300">{t('featureUi.settings.devices.otherDevices.logout')}</Text>
              </Button>
            </Box>
          </Box>
        </Menu>
