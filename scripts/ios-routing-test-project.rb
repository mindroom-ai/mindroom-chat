...
ui_tests = project.new_target(:ui_test_bundle, 'BackgroundResumeTests', :ios, '16.4')
...
info['UIApplicationSceneManifest']['UISceneConfigurations']['UIWindowSceneSessionRoleApplication'][0]['UISceneDelegateClassName'] = '$(PRODUCT_MODULE_NAME).BackgroundResumeSceneDelegate'
